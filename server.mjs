...
import { appendMarketCSV } from './lib/storage/market-csv.mjs';
...
async function runSweepCycle() {
  ...
  try {
    ...
    // 2a. Append market data to CSV
    const yfData = rawData.sources?.YFinance;
    if (yfData) await appendMarketCSV(yfData, RUNS_DIR);
